# Roadmap — csl-pyutil interconnection, 2026-08

_Created: 26-08-2026 · Last updated: 26-08-2026_

Index: [PLAN_CSL_PYUTIL_INTERCONNECTION_2026-08.md](https://github.com/sanskrit-lexicon/csl-pyutil/blob/main/docs/PLAN_CSL_PYUTIL_INTERCONNECTION_2026-08.md).
...
## Wave 1 — csl-pyutil's wiring change

- [ ] [H3573 (Sonnet 5)](https://github.com/gasyoun/Uprava/blob/main/handoffs/H3573-Sonnet_csl-pyutil_interconnect-cslpyutil-claudemd-findings-pointer_26.08.26.md) · trivial
...
For csl-pyutil specifically: wiring score at or above **36** (or a written reason it
